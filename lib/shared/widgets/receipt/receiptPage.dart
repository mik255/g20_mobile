          ...
          children: [
            Container(
                ...
                child: Swiper(
                  ...
                  itemCount: widget.receipt.stories!.length,
                          ...
                          child: Column(
                            children: [
                              ...
                              ListView.builder(
                                  ...
                                  shrinkWrap: true,
                                  itemCount:
                                  widget.receipt.stories![i].products!.length,
                                  itemBuilder: (context, index) {
                                    var item = widget.receipt.stories![i].products!
                                        .toList()[index];
                                    return Column(
                                      children: [
                                        item.count != 0
                                        ...
                                        item.count != 0
                                          ...
                                          height: 8,
                                            ...
                                            : Container(),
                                        if (index ==
                                            widget.receipt.stories![i].products!
                                                .length -
                                                1)
                                          Container(
                                            decoration: BoxDecoration(
                                            ...
                                            child: Padding(
                                              ...
                                              child: Row(
                                                children: [
                                                  ...
                                                  Spacer(),
                                                  Text(
                                                    'Lojista/${widget.receipt.paymentType}',
                                                    style: TextStyle(
                                                        color: Colors.white,
                                                        fontWeight: FontWeight.bold,
                                                        fontSize: 18),
            ...
            Align(
              ...
              child: IconButton(
                  icon:Icon(Icons.share), onPressed: ()async { await _takeScreenshotandShare(); },),
            ),
